    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">客户模块管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">客户模块管理</li>
                        <li class="breadcrumb-item active">客户模块列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">客户模块列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                 
                                        <label>
                                            名称
                                            <input type="text" id="khnameSearch" style="width: 140px;" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //手机号
        var khphoneCell = document.createElement('td');
        khphoneCell.innerHTML = item.khphone;
        row.appendChild(khphoneCell);


        //所在公司
        var gongshiCell = document.createElement('td');
        gongshiCell.innerHTML = item.gongshi;
        row.appendChild(gongshiCell);
