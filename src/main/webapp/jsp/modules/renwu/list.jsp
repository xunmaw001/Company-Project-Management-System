                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            任务名称
                                            <input type="text" id="rwnameSearch" style="width: 140px;" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //任务类型
        var rwleixTypesCell = document.createElement('td');
        rwleixTypesCell.innerHTML = item.rwleixValue;
        row.appendChild(rwleixTypesCell);
