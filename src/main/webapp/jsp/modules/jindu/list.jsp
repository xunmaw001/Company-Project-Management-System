    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">项目进度管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">项目进度管理</li>
                        <li class="breadcrumb-item active">项目进度列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">项目进度列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                            ...
                                            <label>
                                                进度报工
                                                <input type="text" id="scheduleSearch"  style="width: 120px;" class="form-control form-control-sm"
                                            ...
                                            <label>
                                                ...
                                                <input type="text" id="nameSearch"  style="width: 120px;" class="form-control form-control-sm"
                                                       placeholder="负责人名称" aria-controls="tableId">
                                            </label>
