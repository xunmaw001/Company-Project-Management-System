    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑合同模块</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑合同模块</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">合同模块信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>手机号</label>
                                        <input id="khphone" name="khphone" class="form-control"
                                               placeholder="手机号" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>所在公司</label>
                                        <input id="gongshi" name="gongshi" class="form-control"
                                               placeholder="所在公司" readonly>
                                    </div>
                            <!-- 当前表的字段 -->
                                ...
                                <input id="kehuId" name="kehuId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>合同文件</label>
                                        <input name="file" type="file" class="form-control-file" id="httongFileupload">
                                        <label id="httongFileName"></label>
                                        <input name="httongFile" id="httongFile-input" type="hidden">
                                    </div>
                                   <div class="form-group  col-md-6">
                                       <label>合同详情</label>
...
<script>
    ...
    function upload() {
        ...
        $('#httongFileupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                document.getElementById('httongFile-input').setAttribute('value', baseUrl + 'file/download?fileName=' + data.result.file);
                document.getElementById('httongFileName').innerHTML = "上传成功!";
            }
        });
        ...
        function initializationkehuSelect() {
            ...
            if(kehuSelect != null && kehuOptions != null  && kehuOptions.length > 0 ) {
                for (var i = 0; i < kehuOptions.length; i++) {
                        kehuSelect.add(new Option(kehuOptions[i].khname, kehuOptions[i].id));
                }
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function neirongContentChickValue(e){
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#httongFile").val(ruleForm.httongFile);
    ...
    function kehuDataBind(){
        ...
        $("#khphone").val(ruleForm.khphone);
        $("#gongshi").val(ruleForm.gongshi);
    }
