            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">合同模块登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="khphone" name="khphone" class="form-control"
                                                   v-model="ruleForm.khphone" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="gongshi" name="gongshi" class="form-control"
                                                   v-model="ruleForm.gongshi" readonly>
                                        </div>
...
<script>
    ...
    function setDownloadBtn() {
        var httongFileUrl = "download('" + ruleForm.httongFile + "')";
        $("#httongFile").attr("onclick", httongFileUrl);
