            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">项目信息模块登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xmname" name="xmname" class="form-control"
                                               v-model="ruleForm.xmname" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="schedule" name="schedule" class="form-control"
                                               v-model="ruleForm.schedule" readonly>
                                    </div>
...
<script>
    ...
    function setDownloadBtn() {
        var qidongshuFileUrl = "download('" + ruleForm.qidongshuFile + "')";
        $("#qidongshuFile").attr("onclick", qidongshuFileUrl);
