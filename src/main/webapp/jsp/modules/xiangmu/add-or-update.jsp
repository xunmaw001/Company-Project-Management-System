    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑项目信息模块</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑项目信息模块</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">项目信息模块信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input id="expense" name="expense" class="form-control"
                                            onchange="expenseChickValue(this)" placeholder="项目费用">
                                 </div>
                                    <div class="form-group col-md-6">
                                        <label>项目启动书</label>
                                        <input name="file" type="file" class="form-control-file" id="qidongshuFileupload">
                                        <label id="qidongshuFileName"></label>
                                        <input name="qidongshuFile" id="qidongshuFile-input" type="hidden">
                                    </div>
...
<script>
    ...
    function upload() {
        ...
        $('#qidongshuFileupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                document.getElementById('qidongshuFile-input').setAttribute('value', baseUrl + 'file/download?fileName=' + data.result.file);
                document.getElementById('qidongshuFileName').innerHTML = "上传成功!";
            }
        });
