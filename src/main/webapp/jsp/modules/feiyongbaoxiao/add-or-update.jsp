    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑费用报销单</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">费用报销单管理</li>
                        <li class="breadcrumb-item active">编辑费用报销单</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">费用报销单信息</h3>
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                 <div class="form-group col-md-6">
                                     ...
                                     <input id="expense" name="expense" class="form-control"
                                            onchange="expenseChickValue(this)" placeholder="花费金额">
                                 </div>
                                 <div class="form-group col-md-6">
                                     <label>报销金额</label>
                                     <input id="bxexpense" name="bxexpense" class="form-control"
                                            onchange="bxexpenseChickValue(this)" placeholder="报销金额">
                                 </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#yonghuId") !=null){
            ...
            httpJson("feiyongbaoxiao/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addfeiyongbaoxiao');
    ...
    //数字检查
        ...
        function bxexpenseChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[1-9][0-9]{0,5}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
    ...
    // 获取当前详情
    function getDetails() {
        var addfeiyongbaoxiao = window.sessionStorage.getItem("addfeiyongbaoxiao");
        if (addfeiyongbaoxiao != null && addfeiyongbaoxiao != "" && addfeiyongbaoxiao != "null") {
            window.sessionStorage.removeItem('addfeiyongbaoxiao');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("feiyongbaoxiao/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#bxexpense").val(ruleForm.bxexpense);
