    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">费用报销单管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">费用报销单列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">费用报销单列表</h3>
                            ...
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <input type="text" id="bxnameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="花费原因" aria-controls="tableId">
                                        </label>
                                            ...
                                            <label>
                                                ...
                                                <input type="text" id="nameSearch"  style="width: 120px;" class="form-control form-control-sm"
                                                       placeholder="花费人" aria-controls="tableId">
                                            </label>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //报销金额
        var bxexpenseCell = document.createElement('td');
        bxexpenseCell.innerHTML = item.bxexpense;
        row.appendChild(bxexpenseCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("feiyongbaoxiao/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addfeiyongbaoxiao", "addfeiyongbaoxiao");
        window.location.href = "add-or-update.jsp"
    }
